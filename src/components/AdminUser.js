...
function AdminUser() {
    ...
    const [newUser, setNewUser] = useState({ username: '', password: '', email: '', first_name: '', last_name: '', role: 'User' });
    ...
    const handleCreateUser = () => {
        axios.post('http://localhost:5000/api/users/register', newUser)
            .then(() => {
                ...
                setNewUser({ username: '', password: '', email: '', first_name: '', last_name: '', role: 'User' });
    ...
    const handleUpdateUser = () => {
        axios.put(`http://localhost:5000/api/users/profile/${editUser.user_id}`, editUser)
            .then(() => {
                fetchUsers();
                setEditUser(null);
    ...
    const handleBack = () => {
        navigate('/admin'); // Ganti '/admin' dengan route yang sesuai untuk halaman admin
    };
        ...
        <div className="bg-gray-900 text-white min-h-screen flex flex-col items-center p-8">
            ...
            <div className="overflow-x-auto w-full">
                <table className="table-auto w-full bg-gray-800 text-white rounded-lg shadow-md">
                    ...
                    <tbody>
                        {users.map(user => (
                            <tr key={user.user_id} className="text-center border-b border-gray-700">
