    ...
    <div className="signup-container">
      <div className="signup-content">
        ...
        <div className="signup-form">
          ...
          <p className='sign-in'>Already have an account? <a href="/signin-admin">Log In</a></p>
          <p className="terms">
            By signing up, I agree to the <a href="/">Terms & Conditions</a> and <a href="/">Privacy Policy</a>.
          </p>
        </div>
      </div>
    </div>
